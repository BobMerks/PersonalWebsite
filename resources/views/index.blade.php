  ...
  <section id="projects" class="projects">
    <div class="projects-content">
      <div class="projects__container">
        ...
        <div class="projects__container-image"><p>Image coming soon.</p></div>
        <div class="projects__container-description">
          <p class="projects__container-text">A (re)make of my personal website, since I never really finished
            the first version I had. It's still a work in progress and it
            isn't fully responsive yet and there are some features I want to add, like finishing my projects page.</p>
          <div class="projects__container-links">
            <a href="https://github.com/BobMerks/PersonalWebsite" target="_blank" class="projects__container-links-link">GitHub</a>
          </div>
        </div>
      </div>
      ...
      <div class="projects__container">
        ...
        <div class="projects__container-description">
          <p class="projects__container-text">During a school project we ran into an issue with converting existing JSON
            ...
            graph.</p>
          <div class="projects__container-links">
            <a href="https://github.com/BobMerks/JavaScriptJsonToRadar" target="_blank" class="projects__container-links-link">GitHub</a>
          </div>
        </div>
      </div>
      ...
      <div class="projects__container">
        ...
        <div class="projects__container-description">
          ...
          <div class="projects__container-links">
            <a href="https://github.com/BobMerks/JavaScriptSorting" target="_blank" class="projects__container-links-link">GitHub</a>
          </div>
        </div>
      </div>
...
{{--          </div>--}}
      ...
      <div class="projects__container">
        <div class="projects__container-title">
          ...
          <span class="projects__container-title--date">January 2019</span>
        </div>
        <div class="projects__container-image"><p>Image coming soon.</p></div>
        <div class="projects__container-description">
          <p class="projects__container-text">
